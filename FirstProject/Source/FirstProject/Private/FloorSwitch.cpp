...
void AFloorSwitch::BeginPlay()
{
	...
	TriggerBox->OnComponentEndOverlap.AddDynamic(this, &AFloorSwitch::OnvOverlapEnd);
...
void AFloorSwitch::OnvOverlapEnd(UPrimitiveComponent * OverlappedComponent, AActor * OtherActor, UPrimitiveComponent * OtherComp, int32 OtherBodyIndex)
{
