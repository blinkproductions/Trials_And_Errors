...
AItem::AItem()
{
	...
	IdleParticleComponent = CreateDefaultSubobject<UParticleSystemComponent>(FName("IdleParticleSystemComponent"));
...
void AItem::OnOverlapBegin(UPrimitiveComponent * OverlappedComponent, AActor * OtherActor, UPrimitiveComponent * OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult & SweepResult)
{
	...
	if (OverlapParticles) // this means if OverlapParticles is set then do this
	{
